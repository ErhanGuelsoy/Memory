...
* Controls the food memory game.
  ...
  * @returns Card markup.
    */
    ...
    return `      <div class="memory__card-inner">          <div class="memory__card-front">              <img src="./assets/images/food_card.png"
  ...
  * Sets up the exit popup.
    */
    ...
    this.setupExitEvents(exitButton, exitPopup, popup, backToGame, exitGame);
    }
